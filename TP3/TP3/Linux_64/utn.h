...
/**
utn_getEntero: pide un numero entero y utiliza getInt para validarlo pero sin maximo y minimo
    @param pNum: puntero a numero
    @param reint: cantidad de reintentos
    @param msg: mensaje a mostrar
    @param msgError: mensaje de error
...
/**
    utn_getCuit:recibe una cadena de caracteres con un mensaje y un mensaje de error para pedirle al usuario que ingrese un cuit
    @param *pNombre: guarda el Array o cadena de caracteres recibida
